...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">tienda-front documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AdmProductsComponent.html" data-type="entity-link" >AdmProductsComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/AdmUsersComponent.html" data-type="entity-link" >AdmUsersComponent</a>
                            </li>
                            <li class="link">
